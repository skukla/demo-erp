/*
 * Monotonic counters. The sales-order number never rewinds, not even across a wipe,
 * so a number a Commerce order carries from before a reset can never collide with a
 * new one (decision 8 of the plan).
 */
...
/** @returns {string} an SAP-style ten-digit sales order number */
function formatOrderNumber (value) {
  return String(value).padStart(10, '0')
}

module.exports = { next, formatOrderNumber }
